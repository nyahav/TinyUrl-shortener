    ...
    public ModelAndView getTiny(@PathVariable String tiny) throws JsonProcessingException {
        ...
        if (longUrl != null) {
            ...
            if (!longUrl.startsWith("http://") && !longUrl.startsWith("https://")) {
                longUrl = "http://" + longUrl; // Prepend http:// if not already present
            }
            ...
            return new ModelAndView("redirect:" + longUrl); // Redirect to the fixed longUrl
        } else {
            throw new RuntimeException(tiny + " not found");
        }
    }
